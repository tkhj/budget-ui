...
(function() {
    ...
    function UserService($log, $http) {
        ...
        function checkLoggedIn() {
            ...
            return $http({
                url: 'http://localhost/personal/dndspells2-api/api.php/api/user/currentUser',
                method: 'GET',
        ...
        function signupUser(userData) {
            ...
            return $http({
                url: 'http://localhost/personal/dndspells2-api/api.php/api/user/signup',
                method: 'POST',
                data: postData,
                withCredentials: true,
                headers: {
        ...
        function loginUser(userData) {
            ...
            return $http({
                url: 'http://localhost/personal/dndspells2-api/api.php/api/user/login',
                method: 'POST',
                data: postData,
                withCredentials: true,
                headers: {
        ...
        function logoutUser() {
            ...
            return $http({
                url: 'http://localhost/personal/dndspells2-api/api.php/api/user/logout',
                method: 'POST',
                data: currUserData,
                withCredentials: true,
                headers: {
